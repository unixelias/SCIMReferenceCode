...
namespace CareEvolution.SCIM
{
    public static class Core2UserExtensions
    {
        public static void Apply(this Core2User user, PatchRequest2Base<PatchOperation2> patch)
        {
            if (null == user)
            {
        ...
        public static void Apply(this Core2User user, PatchRequest2 patch)
        {
            if (null == user)
            {
                throw new ArgumentNullException(nameof(user));
        ...
        private static void Apply(this Core2User user, PatchOperation2 operation)
        {
            if (null == operation)
            {
                return;
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "None")]
        public static void PatchAddresses(this Core2User user, PatchOperation2 operation)
        {
            if (null == operation)
            {
                return;
        ...
        private static void PatchElectronicMailAddresses(this Core2User user, PatchOperation2 operation)
        {
        ...
        private static void PatchEnterpriseExtension(this Core2EnterpriseUser user, PatchOperation2 operation)
        {
            ...
            switch (operation.Path.AttributePath)
            {
                case AttributeNames.CostCenter:
                    Core2UserExtensions.PatchCostCenter(extension, operation);
                    break;

                case AttributeNames.Department:
                    Core2UserExtensions.PatchDepartment(extension, operation);
                    break;

                case AttributeNames.Division:
                    Core2UserExtensions.PatchDivision(extension, operation);
                    break;

                case AttributeNames.EmployeeNumber:
                    Core2UserExtensions.PatchEmployeeNumber(extension, operation);
                    break;

                case AttributeNames.Manager:
                    Core2UserExtensions.PatchManager(extension, operation);
                    break;

                case AttributeNames.Organization:
                    Core2UserExtensions.PatchOrganization(extension, operation);
                    break;
            }
        }
        ...
        private static void PatchName(this Core2User user, PatchOperation2 operation)
        {
            if (null == operation)
            {
                return;
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "None")]
        private static void PatchPhoneNumbers(this Core2User user, PatchOperation2 operation)
        {
            if (null == operation)
            {
                return;
        ...
        private static void PatchRoles(this Core2User user, PatchOperation2 operation)
        {
